...
-- * lbc_champion = Leona // if this script is for a special champ
-- * lbc_tags = Leona, support, tank, AP, Kool, kool, iskool, koolkaracter
-- * lbc_link = http://leaguebot.net/forum/Upload/showthread.php?tid=4351
-- * lbc_source = https://raw.githubusercontent.com/koolkaracter/Scripts/AutoKool/Champs/LeonaIsKool.lua
...
--[[	
.____                                .___          ____  __.            .__   
|    |    ____  ____   ____ _____    |   | ______ |    |/ _|____   ____ |  |  
|    |  _/ __ \/  _ \ /    \\__  \   |   |/  ___/ |      < /  _ \ /  _ \|  |  
|    |__\  ___(  <_> )   |  \/ __ \_ |   |\___ \  |    |  (  <_> |  <_> )  |__
...
local skillOrder = {}
local qRange, wRange, eRange, rRange = 185, 425, 850, 1175      					
local qSpeed, wSpeed, eSpeed, rSpeed = nil, nil, 1900, 2000     					
local qDelay, wDelay, eDelay, rDelay = 0, 3, .5, .625          					
local qWidth, wWidth, eWidth, rWidth = nil, nil, 100, 125								
...
submenu.slider('TS_Range', 'Range For Auto Selection', 1,2,1, {900, 1175}) 						
...
menu.label('lb01', ' ')
menu.label('lb02', 'Leona Is Kool Version '..tostring(Version) ..' by KoolKaracter')
------------------------------------------------------------  
------------------------End Of Menu-------------------------
------------------------------------------------------------
...
function UseDefensiveItems()
	if IsBuffed(myHero, "FountainHeal") ~= true then
		...
		elseif Cfg['4. Item Options'].Require_Targ_For_D_I_ON ~= true and ally ~= nil and ally.team == myHero.team and ally.visible == 1 and GetDistance(myHero, ally) < 600 then
...
function KillSteal()
	...
	for i = 1, objManager:GetMaxHeroes() do
          local ksTarg = objManager:GetHero(i)
			...
			if Cfg['7. Kill Steal Options'].KSR and ksTarg ~= nil and ksTarg.team ~= myHero.team and ValidTarget(ksTarg) and GetDistance(myHero, ksTarg) < rRange and getDmg('R', ksTarg, myHero) >= ksTarg.health then UseRKS(ksTarg) end
